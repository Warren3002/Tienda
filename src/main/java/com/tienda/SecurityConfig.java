...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    //metodos para hacer autenticacion de usuario
    @Override
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
//        auth.inMemoryAuthentication() //autentificacion en memoria 
//                .withUser("admin")
//                .password("{noop}123")
...
//                .roles("USER");
    ...
    //el siguinete metodo funciones para realizar la autenticacion de accesos 
    @Override
